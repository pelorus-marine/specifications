...
| 06 | [`06-signal-catalog.md`](./06-signal-catalog.md) | `Vessel.*` semantic catalog, instance handling | Draft | Unverified |
| 07 | [`07-dcid-registry.md`](./07-dcid-registry.md) | DCID numeric assignments | Draft | Unverified |
...
| Old | New | Note |
|---|---|---|
| 04 (power) | 04 | strip §1–3 rationale + §4 free references |
| 05 (addressing) | 05 | unchanged number |
