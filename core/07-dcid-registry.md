...
| `Pelorus.AISClassAPosition` | `0x00110` | 4 | 129038 | `Vessel.AIS.TargetClassA[*].Position` |
| `Pelorus.AISClassBPosition` | `0x00111` | 4 | 129039 | `Vessel.AIS.TargetClassB[*].Position` |
| `Pelorus.AISClassBExtPosition` | `0x00112` | 4 | 129040 | `Vessel.AIS.TargetClassB[*].PositionExt` |
| `Pelorus.AISUTCDate` | `0x00113` | 4 | 129793 | `Vessel.AIS.UTCDate` |
| `Pelorus.AISClassAStatic` | `0x00114` | 4 | 129794 | `Vessel.AIS.TargetClassA[*].Static` |
| `Pelorus.AISClassBStaticA` | `0x00115` | 4 | 129809 | `Vessel.AIS.TargetClassB[*].StaticA` |
| `Pelorus.AISClassBStaticB` | `0x00116` | 4 | 129810 | `Vessel.AIS.TargetClassB[*].StaticB` |
